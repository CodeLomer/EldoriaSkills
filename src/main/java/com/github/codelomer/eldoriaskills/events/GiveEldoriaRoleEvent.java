...
public class GiveEldoriaRoleEvent extends Event implements Cancellable {
    private static final HandlerList handlers = new HandlerList();
    private boolean cancelled;
    @Getter
    private final @NonNull EldoriaPlayer player;
    @Getter
    private final @NonNull EldoriaRole newRole;
    @Getter
    private final @NonNull EldoriaRace newRace;
